...
class PaceSlider extends StatefulWidget {
  ...
  final Size size;
  PaceSlider({Key? key, required this.controller, required this.onChange, required this.size}) : super(key: key);
...
class _PaceSliderState extends State<PaceSlider> {
   ...
   String LastValue = "";
   String ConvertDoubleToPace(double value)
   {
     ...
     return SleekCircularSlider(
      ...
      appearance: CircularSliderAppearance(
        ...
        infoProperties: InfoProperties(
          modifier: (value) => ConvertDoubleToPace(value),
      ...
      onChange: (double value) {
        widget.controller.text = ConvertDoubleToPace(value);
        widget.onChange();
      },
    );
  }
